      ...
      <div class="default-management-list users-management">
        <div class="container cnt-spc">
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="left-header management-header" style="text-align:left">
                <h1 >Users managements</h1>
              </div>
            </div>
            <div class="col-md-6">
              <div class="right-header management-header" style="text-align:left">
                <?php
                    if($_SESSION['type'] == 2)
                    {
                        ?>
                      ...
                      foreach($users as $user)
                      {
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            {
                              ?>
                              <span class="type e-ty">store</span>
                              <?php
                            }
...
<h3> <a style="margin-left:5px;font-size:15px;border-radius: 10px;background:var(--mainColor);color:white;padding:8px" href ="users.php?page=manage" class="fas fa-long-arrow-alt-right"></a> Fill in the information to add a new supervisor </h3>                    <div class="err-msg">
          ...
          <div class="edit-page user-edit-pages deep-page">
            <div class="container cnt-spc">
              <div class="row">
                <div class="col-md-12">
                  <div class="pg-tt">
                    <h1 dir="rtl" style="display:block;text-align:left">Edit user -  <?php echo $userInfo['fname'] ?></h1>
                  </div>
                </div>
    ...
    elseif ($page == 'update') {
      ...
      $id = $_POST['id'];
                            ...
                            if (empty($formErrors))
                            {
                              ...
                              $stmt = $conn->prepare("UPDATE users SET username = ?, fname = ?, email = ?, password = ? , phone = ?, type = ?
                                 WHERE id=?  ");
                              $stmt->execute(array($username,$fname,$email,$password, $phone, $type, $id));
                              header('location: ' . $_SERVER['HTTP_REFERER']);
                            }
                          }
