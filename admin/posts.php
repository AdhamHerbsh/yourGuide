                ...
                <div class="management-body">
                    ...
                    ?>
                          ...
                          ?>
                                    ...
                                    <td>
                                        <p><?php $text = strip_tags($post['content']);
                              echo mb_strimwidth($text, 0, 60, "...")  ?></p>
                                    </td>
                                            ...
                                            <li class=" dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                    <a class="dropdown-item"
                                                        href="posts.php?page=edit&id=<?php echo $post['id'] ?>">
                                                        <svg width="24" height="auto" viewBox="0 0 24 24" fill="none"
                                                            ...
                                                            <path
                                                                ...
                                                                fill="black" />
                                                            <path
                                                                d="M7 14.987V16.986H8.999L14.528 11.464L12.53 9.466L7 14.987Z"
                                                                fill="black" />
                                                            <path
                                                                d="M15.47 10.522L13.472 8.522L14.995 7L16.995 8.999L15.47 10.522Z"
                                                                fill="black" />
                                                        </svg>
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="posts.php?page=delete&id=<?php echo $post['id'] ?>">
                                                        <svg width="16" height="auto" viewBox="0 0 16 16" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path
...
<div class="add-default-page add-post-page  add-product-page " id="add-page">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <form class="add-fomr" method="POST" action="posts.php?page=insert" enctype="multipart/form-data"
                    id="ca-form-info">
                    <h3>add new post<a
                            style="margin-left:5px;font-size:15px;border-radius: 10px;background:var(--mainColor);color:white;padding:8px"
                            href="posts.php?page=manage" class="fas fa-long-arrow-alt-right"></a>
                    </h3>
                    <div class="row">
...
<?php
      ...
      if (empty($formErrors)) {
        ...
        $stmt = $conn->prepare("INSERT INTO posts(title, content, image, visibility, type, userid, created)
                                 VALUES(:ztitle,:zcontent, :zimg, :zvisi, :zuser, now())");
        $stmt->execute(array(
          'ztitle' => $title,
          'zcontent' => $content,
          'zimg' => $image,
        ...
        <div class="row justify-content-start">
            <div class="col-md-12">
                <div class="pg-tt" style="text-align:left">
                    <h1><a style="margin-left:5px;font-size:15px;border-radius: 10px;background:var(--mainColor);color:white;padding:8px"
                            href="posts.php?page=manage" class="fas fa-long-arrow-alt-left"></a>edit post -
                        <?php echo $postinfo['title'] ?> </h1>
            ...
            <div class="col-md-7">
                <div class="use-fl-info">
                    <form class="form" method="post" action="posts.php?page=update&id=<?php echo $postinfo['id'] ?>"
                        enctype="multipart/form-data" style="margin-bottom:60px">
                        <input type="hidden" name="id" value="<?php echo $postinfo['id'] ?>">
                        <div class="row">
                            <div class="col-12">
                                <label for="title">title</label>
                                <input type="text" id="title" class="form-control" name="title" placeholder=""
                                    value="<?php echo $postinfo['title'] ?>">
                            </div>
                            ...
                            <div class="col-12">
                                <label for="visibility">vision</label>
                                <select class="form-control" name="visibility">
                                    <option value="0" <?php if ($postinfo['visibility'] == 0) {
                                            echo 'selected';
                                          } ?>>hidden</option>
                                    <option value="1" <?php if ($postinfo['visibility'] == 1) {
                                            echo 'selected';
                                          } ?>>visible</option>
                                </select>
                            ...
                            <div class="form-group col-12">
                                ...
                                <textarea name="content"
                                    class="form-control ckeditor"><?php echo $postinfo['content'] ?></textarea>
                            </div>
                            <div class="col-6">
...
<?php
        ...
        if (empty($formErrors)) {
          ...
          $stmt = $conn->prepare("UPDATE posts SET title = ?,content = ?,image=?,visibility = ? WHERE id=? LIMIT 1  ");
          $stmt->execute(array($title, $content, $image, $visibility, $id));
          header('location: posts.php?page=manage');
        }
      } else {
        header('location: posts.php');
