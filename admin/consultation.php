...
<li></li>
      ...
      <?php
          ...
          {
            ?>
            <span style="font-size: 11px;color:red;padding-top:10px">في انتظار الرد</span>
            <?php
          }
          if (!empty($post['repons']))
          {
            ?>
            <span style="color:green">تم الرد  <i style="margin-top:10px;;font-size:8px;background:green" class="fas fa-check"> </i> </span>
            <?php
          }
       ?>
                                </a>
          ...
          <form class="add-fomr" method="POST" action="consultation.php?page=insert" enctype="multipart/form-data"  id="ca-form-info"  >
            <h3> <?php echo $data['fname'] ?> <a style="margin-left:5px;font-size:15px;border-radius: 10px;background:var(--mainColor);color:white;padding:8px" href="consultation.php?page=manage" class="fas fa-long-arrow-alt-right"></a>  </h3>
              <div class="row">
                ...
                <div class="col-md-6 ">
                  <input type="text" name="qst" disabled value="<?php echo $data['title'] ?>"  placeholder="" id="" value="">
                </div>
                <div class="col-md-12 ">
